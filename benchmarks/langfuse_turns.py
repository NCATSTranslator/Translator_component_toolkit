...
from TCT.interfaces import invocation, telemetry
...
def _collect_turn(calls: list[list[str]]) -> dict[str, Any]:
    ...
    original_observer = telemetry.observe_tool
    telemetry.observe_tool = collect_observation
    try:
        ...
        telemetry.observe_tool = original_observer
